...
echo
figlet "Localization"
artools-chroot /mnt ln -sf /usr/share/zoneinfo/$zone /mnt/etc/localtime
...
artools-chroot /mnt grub-install --target=x86_64-efi --efi-directory=/mnt/boot/efi --bootloader-id=GRUB
